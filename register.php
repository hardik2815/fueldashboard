	...
	<div class="row">
		...
		<div class="col-lg-12">
			<form action="" method="post">
				...
				<div class="form-group">
					<label for="exampleInputph">Phone Number</label>
					<input type="text" class="form-control" id="ph" name="ph" placeholder="Enter your Phone Number">
					<small id="phno" class="form-text text-muted">Must be 10 digits only.</small>
				</div>
				<div class="form-group">
